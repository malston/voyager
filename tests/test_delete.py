...
def mock_github_setup():
    ...
    with patch('voyager.commands.delete.check_git_repo', return_value=True), \
         patch('voyager.commands.delete.get_repo_info', return_value=('test-owner', 'test-repo')), \
         patch('voyager.commands.delete.GitHubClient') as mock_github, \
