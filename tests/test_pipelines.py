...
def mock_concourse_setup():
    ...
    with patch('voyager.commands.pipelines.check_git_repo', return_value=True), patch(
        'voyager.commands.pipelines.get_repo_info', return_value=('test-owner', 'test-repo')
