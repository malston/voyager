...
class GitHubClient:
    ...
    def __init__(self, token: Optional[str] = None):
        ...
        if not self.token:
            raise ValueError("GitHub token not found. Please set GITHUB_TOKEN environment variable or provide it explicitly.")
    ...
    def create_release(self, owner: str, repo: str, tag_name: str, name: str, body: str, 
